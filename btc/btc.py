...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
  UravxBuCwNMpYWTzKhPI("Facebook : Antoxa Kuklin")
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
  UravxBuCwNMpYWTzKhPI("Country : Rossia")
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-')
  UravxBuCwNMpYWTzKhPI(" Author : Antoxa421")
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
